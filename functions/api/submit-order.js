...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="section">
        ...
        <div class="info-row">
          ...
          <span class="info-value">${customer.commune}</span>
        </div>
        ` : ''}
        ${customer.address ? `
        <div class="info-row">
        ...
        <div class="info-row">
          ...
          <span class="info-value">
            ${customer.deliveryType === "desk" ? "Stop Desk Yalidine" : "À Domicile"}
            <span class="delivery-badge">${customer.deliveryType === "desk" ? "🏪 DESK" : "🏠 HOME"}</span>
          </span>
        </div>
      </div>
        ...
        <div class="product-box">
          ...
          <div class="product-details">
            ...
            <div class="info-row">
              ...
              <span>${cart.productPrice.toLocaleString("fr-FR")} DA</span>
            </div>
          </div>
        </div>

        ${cart.includeBump ? `
        <div class="product-box" style="background: #fff8f0; border-left: 4px solid #ff9800;">
          <div class="product-name">👛 Portefeuille (Order Bump)</div>
          <div class="product-details">
            <div class="info-row">
              <span>Prix :</span>
              <span>${cart.bumpPrice.toLocaleString("fr-FR")} DA</span>
            </div>
          </div>
        </div>
        ` : ''}
      ...
      <div class="section">
        <div class="totals">
          <div class="total-row">
            ...
            <span>${totals.subtotal.toLocaleString("fr-FR")} DA</span>
          </div>
          ${totals.bump > 0 ? `
          <div class="total-row">
            <span>Order Bump :</span>
            <span>+${totals.bump.toLocaleString("fr-FR")} DA</span>
          </div>
          ` : ''}
          <div class="total-row grand-total">
            <span>💰 TOTAL :</span>
            <span>${totals.grandTotal.toLocaleString("fr-FR")} DA</span>
          </div>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <div class="info-row">
          ...
          <span class="info-value" style="color: #ff9800; font-weight: bold;">⏳ EN ATTENTE DE CONFIRMATION</span>
        </div>
      </div>
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
      <p>📧 Cet email a été généré automatiquement par le système Kiffane.com</p>
      <p>Pour toute question, veuillez contacter : hello@kiffane.com</p>
    </div>
  </div>
</body>
</html>
